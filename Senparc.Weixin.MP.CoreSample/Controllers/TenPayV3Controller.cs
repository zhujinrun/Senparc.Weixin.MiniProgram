...
<return_msg><![CDATA[{1}]]></return_msg>
        ...
        public ActionResult CloseOrder()
        {
            ...
            var requestData = new TenPayV3CloseOrderRequestData(TenPayV3Info.AppId, TenPayV3Info.MchId, "", TenPayV3Info.Key, nonceStr, "MD5");
            var result = TenPayV3.CloseOrder(requestData);
